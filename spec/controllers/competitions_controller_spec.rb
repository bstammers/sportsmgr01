...
describe CompetitionsController do
  ...
  #    competition = Competition.create! valid_attributes
      get :show, id: comp1
      assigns(:competition).should eq(comp1)
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      before :each do
        @comp2 = FactoryGirl.create(:competition)
      end
      it "updates the requested competition" do
        ...
        put :update, id: @comp2, competition: FactoryGirl.attributes_for(:competition, name: "Second Comp")
        @comp2.reload
        @comp2.name.should eq("Second Comp")
      end

      it "assigns the requested competition as @competition" do
        #competition = Competition.create! valid_attributes
        put :update, id: @comp2, competition: FactoryGirl.attributes_for(:competition)
        assigns(:competition).should eq(@comp2)
      end

      it "redirects to the competition" do
        #competition = Competition.create! valid_attributes
        put :update, id: @comp2, competition: FactoryGirl.attributes_for(:competition)
        response.should redirect_to(@comp2)
      end
    end
