...
describe TeamsController do
  ...
  let(:valid_attributes) { { "teamname" => "MyString" } }
  ...
  describe "PUT update" do
    ...
    describe "with valid params" do
      it "updates the requested team" do
        ...
        #Team.any_instance.should_receive(:update).with({ "teamname" => "MyString" })
        #put :update, {:id => team.to_param, :team => { "teamname" => "MyString" }}, valid_session
        put :update, id: @team2, team: FactoryGirl.attributes_for(:team, teamname: "Second Team")
        @team2.reload
        @team2.teamname.should eq("Second Team")
      end

      it "assigns the requested team as @team" do
        #team = Team.create! valid_attributes
        put :update, id: @team2, team: FactoryGirl.attributes_for(:team)
        assigns(:team).should eq(@team2)
      end

      it "redirects to the team" do
        #team = Team.create! valid_attributes
        put :update, id: @team2, team: FactoryGirl.attributes_for(:team)
        response.should redirect_to(@team2)
      end
    end
